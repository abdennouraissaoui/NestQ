...
class AccountBaseSchema(BaseModel):
    ...
    institution: Optional[str] = Field(description="Institution of the account")
...
class AccountDisplaySchema(AccountBaseSchema):
    ...
    created_at: int = Field(description="Timestamp when the account was created")
...
class AccountUpdateSchema(BaseModel):
    account_type: Optional[AccountType] = Field(description="Type of the account")
    currency: Optional[str] = Field(description="Currency of the account")
    institution: Optional[str] = Field(description="Institution of the account")
